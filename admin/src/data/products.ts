export type Product = {
  ...
  type: "Tees" | "Hoodies" | "Pants" | "Shoes" | "Accessories" | "Jackets";
  price: number;
  compareAt?: number;
  rating: number;
  reviewCount: number;
...
export const categories = [
  ...
  { name: "Shoes", image: u("photo-1542291026-7eec264c27ff") },
  { name: "Accessories", image: u("photo-1521369909029-2afed882baee") },
];
